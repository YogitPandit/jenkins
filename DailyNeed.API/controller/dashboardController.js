'use strict';
app.controller('dashboardController', ['OrderMasterService', '$scope', '$http', "$filter", "ngTableParams", 'ngAuthSettings', 'authService', '$location', function (OrderMasterService, $scope, $http, $filter, ngTableParams, ngAuthSettings, authService, $location) {
    ...
    if (authService.authentication.isAuth == false) {
        ...
        if (authService.authentication.role != "HQ Master login")
        {
