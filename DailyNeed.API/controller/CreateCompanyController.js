'use strict';
app.controller('CreateCompanyController', ['$scope', 'peoplesService', 'CityService', 'StateService', "$filter", "$http", "ngTableParams", '$modal', 'WarehouseService',
...
app.controller("ModalInstanceCtrlCompany", ["$scope", '$http', '$modal', 'ngAuthSettings', "peoplesService", 'CityService', 'StateService', "$modalInstance", "people", 'WarehouseService', 'authService',
...
app.controller("ModalInstanceCtrldeleteCompany", ["$scope", '$http', '$modal', "$modalInstance", "peoplesService", 'ngAuthSettings', "people", function ($scope, $http, $modal, $modalInstance, peoplesService, ngAuthSettings, people) {
