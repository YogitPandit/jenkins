'use strict';
app.controller('UserAccessPermissionController', ['$scope', 'peoplesService', 'CityService', 'StateService', "$filter", "$http", "ngTableParams", '$modal', 'WarehouseService',
...
app.controller("ModalInstanceCtrlUserAccess", ["$scope", '$http', '$modal', 'ngAuthSettings', "peoplesService", 'CityService', 'StateService', "$modalInstance", "people", 'WarehouseService', 'authService',
...
app.controller("showInstanceCtrlPeople", ["$scope", '$http', '$modal', 'ngAuthSettings', "peoplesService", 'CityService', 'StateService', "$modalInstance", "people", 'WarehouseService', 'authService',
    function ($scope, $http, $modal, ngAuthSettings, peoplesService, CityService, StateService, $modalInstance, people, WarehouseService, authService) {
        $scope.UserRole = JSON.parse(localStorage.getItem('RolePerson'));
        console.log("People");
        $scope.ok = function () { $modalInstance.close(); },
