...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
    ...
    var _saveRegistration = function (registration) {
        return $http.post(serviceBase + 'api/account/register?flag=Nomal', registration).success(function (response) {
    ...
    var _login = function (loginData) {
        ...
        $http.post(serviceBase + 'token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
            ...
            if (loginData.useRefreshTokens) {
                localStorageService.set('authorizationData', { token: response.access_token, userName: loginData.userName, CompanyId: response.compid, role: response.role, refreshToken: response.refresh_token, userid: response.userid, Warehouseid: response.Warehouseid, useRefreshTokens: true });
            }
            else {

                localStorageService.set('authorizationData', { token: response.access_token, userName: loginData.userName, CompanyId: response.compid, role: response.role, refreshToken: "", userid: response.userid, Warehouseid: response.Warehouseid, useRefreshTokens: false });
            }
