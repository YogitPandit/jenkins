'use strict'
app.controller('Report3Controller', ['$scope', "$filter", "$http", "ngTableParams", function ($scope, $filter, $http, ngTableParams) {
    $scope.datrange = '';
    $scope.datefrom = '';
    $scope.dateto = '';
    $(function () {
    ...
    $scope.genereteReport = function (data1, filtype) {
        ...
        if ($scope.filtype === "day") {
            ...
            url = serviceBase + "api/Report/day?datefrom=" + $scope.dataforsearch.datefrom + "&dateto=" + $scope.dataforsearch.dateto + "&type=1&value=" + data1.value + "&ids=" + ids;
        }
        else if ($scope.filtype === "month") {
            $scope.frmt = "MMM YY";
            $scope.intervalType = "month";
            url = serviceBase + "api/Report/month?datefrom=" + $scope.dataforsearch.datefrom + "&dateto=" + $scope.dataforsearch.dateto + "&type=1&value=" + data1.value + "&ids=" + ids;
        }
        else if ($scope.filtype === "year") {
            $scope.frmt = "YYYY";
            $scope.intervalType = "year";
            url = serviceBase + "api/Report/year?datefrom=" + $scope.dataforsearch.datefrom + "&dateto=" + $scope.dataforsearch.dateto + "&type=1&value=" + data1.value + "&ids=" + ids;
        }
        $http.get(url)
        .success(function (data) {
            if (data.length == 0) {
