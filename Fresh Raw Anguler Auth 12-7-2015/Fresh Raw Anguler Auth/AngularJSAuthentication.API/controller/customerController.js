'use strict';
app.controller('customerController', ['$scope', 'customerService', "$filter", "$http", "ngTableParams", 'FileUploader', '$modal', '$log', function ($scope, customerService, $filter, $http,FileUploader, ngTableParams, $modal, $log) {
